CREATE TABLE `File` (
  ...
  KEY `IX_File_Shared` (`Shared`),
  KEY `IX_File_MainTag` (`MainTag`),
  CONSTRAINT `FK_File_File_ParentId` FOREIGN KEY (`ParentId`) REFERENCES `File` (`Id`) ON DELETE SET NULL
);
